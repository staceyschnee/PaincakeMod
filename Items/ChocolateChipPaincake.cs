...
{
	public class ChocolateChipPaincake : ModItem
	{ 
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<Projectiles.ChocolateChipPaincakeProjectile>();
...
//#endif
		public override void AddRecipes()
		{
            ...
            recipe.AddIngredient(ModContent.ItemType<CacaoPod>(), 1);
